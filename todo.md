...
- [ ] In the implementation of Gallery Mode within profiles, the load remote media features which are present in the Timeline tab are completely non-functional, they just fail to load and don't even try to do anything else.
- [ ] **change:** The caching of server emote images should have an option to toggle it off, in case someone's tight on storage.
