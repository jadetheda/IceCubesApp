...
- [x] **Big Bug:** The custom ellipsis menu, which is supposed to be exclusive to the **Lists** tab, now shows up in the **Timeline** tab's header, replacing the dynamic ellipsis menu generated by iOS 26.
