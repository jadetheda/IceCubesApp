    ...
    Section {
      if cachedRemoved {
        ...
        public struct AppExport: Codable, Sendable {
          ...
          public init(
            userDefaults: [String: AnyCodable],
            tagGroups: [ExportedTagGroup]?,
            localTimelines: [ExportedLocalTimeline]?
          ) {
          ...
          nonisolated public init(from decoder: Decoder) throws {
            ...
            userDefaults = try container.decode([String: AnyCodable].self, forKey: .userDefaults)
            tagGroups = try container.decodeIfPresent([ExportedTagGroup].self, forKey: .tagGroups)
            localTimelines = try container.decodeIfPresent([ExportedLocalTimeline].self, forKey: .localTimelines)
          }
        ...
        public enum AnyCodable: Codable, Sendable {
          ...
          nonisolated public init(from decoder: Decoder) throws {
            ...
            if let value = try? container.decode(Bool.self) { self = .boolean(value) }
              ...
              throw DecodingError.dataCorruptedError(in: container, debugDescription: "Invalid settings value")
            }
          }
          ...
          public var value: Any {
            ...
            case .dict(let value): return value.mapValues(\.value)
            }
          }
