...
public final class ConversationsListDataSource {
  ...
  public func fetchConversations(client: FediverseClient) async throws -> FetchResult {
  ...
  public func fetchNextPage(client: FediverseClient) async throws -> FetchResult {
  ...
  public func markAsRead(client: FediverseClient, conversation: Conversation) async -> Conversation {
  ...
  public func delete(client: FediverseClient, conversation: Conversation) async throws -> [Conversation] {
  ...
  public func toggleFavorite(client: FediverseClient, conversation: Conversation) async throws -> Conversation {
  ...
  public func toggleBookmark(client: FediverseClient, conversation: Conversation) async throws -> Conversation {
    guard let message = conversation.lastStatus else { return conversation }
