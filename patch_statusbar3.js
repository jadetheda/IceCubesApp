const fs = require('fs');
let content = fs.readFileSync('Packages/Notifications/Sources/Notifications/List/NotificationsListView.swift', 'utf8');
...
fs.writeFileSync('Packages/Notifications/Sources/Notifications/List/NotificationsListView.swift', content);
