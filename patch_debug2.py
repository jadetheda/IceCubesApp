...
target = """                        if let data = try? await makeMisskeyRequest(path: "users/show", params: ["username": parts[0], "host": NSNull()]),
